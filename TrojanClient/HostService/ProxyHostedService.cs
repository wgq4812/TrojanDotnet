...
using TrojanClient.InProxy;
using TrojanClient.Model;
using TrojanClient.OutProxy;
using TrojanClient.Utility;

namespace TrojanClient.HostService
{
    public class ProxyHostedService : IHostedService
    {
        ...
        public ProxyHostedService(ILogger<ProxyHostedService> logger, IOptions<MySetting> options, IUserInput input, IProxySetting proxySetting, TrojanContext trojanContext)
        {
            _logger = logger;
